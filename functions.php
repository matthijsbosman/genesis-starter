...
// Load theme features (do not remove).
// include_once( get_stylesheet_directory() . '/library/core.php' );
...
function genesis_starter_theme_setup() {
	...
	// Add support for WooCommerce and WooCommerce features.
	...
	// Add support for Accessibility enhancements.
	...
	// Add support for viewport meta tag for mobile browsers.
	add_theme_support( 'genesis-responsive-viewport' );

	// Add support for Genesis footer widgets.
	add_theme_support( 'genesis-footer-widgets', 3 );

	// Add support for Gutenberge wide images.
	add_theme_support( 'gutenberg', array(
		'wide-images' => true,
	) );

	// Add support for default posts and comments RSS feed links.
	...
	// Add support for selective refresh and Customizer edit icons.
	...
	// Add support for logo option in Customizer > Site Identity.
	...
	// Add support for custom header image or video.
	...
	// Add support for shortcodes in text widgets.
	...
	// Enqueue scripts and styles at late priority.
 ...
 *
 * Called inside the `genesis_starter_theme_setup()` function.
 *
 * @since  1.0.0
 *
 * @see    http://justintadlock.com/wordpress-theme-function-files
 *
 * @return void
 */
